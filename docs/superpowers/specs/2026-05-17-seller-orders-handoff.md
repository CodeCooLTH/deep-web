...
- **Wireframe:** `docs/mockups/seller-orders/detail.html`. โครง: sticky panel (L37-65) → grid `lg:grid-cols-3`: OrderSummary col-span-2 (L71-108) + CustomerDetails col-span-1 (L111-138) → review card full-width (L143-150) → logs timeline full-width (L153-174) → cancel modal + ship modal
