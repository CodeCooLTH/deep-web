...
**Acceptance Criteria:**
- [ ] มีตัวเลือกภาษาในหน้าตั้งค่าโปรไฟล์ `/account` (มติ D-I18N-4) — **ไม่ใช่บน topbar**
...
- ✅ เปลี่ยนภาษาได้จากหน้าตั้งค่าโปรไฟล์ และหน้าจอเปลี่ยนโดยที่อยู่เว็บไม่ขยับ
...
2. เข้าสู่ระบบ เปิดหน้าตั้งค่าโปรไฟล์ เปลี่ยนภาษาเป็นอังกฤษ แล้วออกจากระบบ
   *(ขั้นตอนนี้ทำก่อนเริ่มบันทึกคลิปจริง เพื่อให้หน้า sign-in ในคลิปเป็นอังกฤษตั้งแต่เฟรมแรก
   ตามกลไกเงา cookie ใน D-I18N-5)*
...
- ภาษาเก็บเป็นคอลัมน์บน `User` ⇒ **ต้องมี migration** และตาม HR15 การ push ขึ้น `main`
  จะรัน migrate บน prod ให้เองในขั้นตอน build — ต้องแจ้งก่อนทุกครั้ง
- หน้าที่ยังไม่ล็อกอินอ่านภาษาจาก cookie ที่เป็นเงาของค่าใน DB ⇒ **เครื่องที่ไม่เคยล็อกอินเลย
  จะเห็นหน้า sign-in เป็นภาษาไทยเสมอ** (มติ D-I18N-5 — ยอมรับข้อจำกัดนี้ และรับมือด้วย
  ลำดับขั้นตอนตอนอัดคลิป ไม่ใช่ด้วยโค้ด)
