...
| **BR-EXP-18-05** | ค่าใช้จ่ายหมวดค่าขนส่งในรายงาน = ผลรวมจากตาราง `Expense` (ที่ร้านพิมพ์เอง) **บวก** ค่าส่งจริงจากพัสดุ active ในช่วงเวลานั้น — สองแหล่ง ห้ามนับซ้ำกันเอง และห้ามให้แหล่งใดแหล่งหนึ่งเขียนทับอีกแหล่ง |
