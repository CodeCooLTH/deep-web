...
**Out-of-scope (ตาม PRD §5):** ส่งต่างประเทศ, ส่งด่วนภายในวัน, การเปรียบเทียบราคาข้ามขนส่งเต็มรูป, การเปลี่ยนสถานะออเดอร์อัตโนมัติจากสถานะขนส่ง (ตั้งใจไม่ทำ — มีเคส negative ยืนยันว่า "ไม่ทำ" แทน), การจัดการเงิน/เติมเงิน iShip
