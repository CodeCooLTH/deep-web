...
| **BR-ISHIP-27** | ค่าเริ่มต้นของการเก็บเงินปลายทางในระบบคือ "ปิด" |
...
| **BR-ISHIP-45** | 🆕 | คำสั่งซื้อจะถูกยืนยันอัตโนมัติได้ **ต่อเมื่อครบทุกข้อ**: (ก) เป็นคำสั่งซื้อเก็บเงินปลายทาง (ข) มีพัสดุที่ผูกกับคำสั่งซื้อนี้อยู่ในระบบ (ค) iShip แจ้ง `settlement_at` และยอด COD มากกว่าศูนย์ (ง) คำสั่งซื้ออยู่ในสถานะรอดำเนินการหรือกำลังจัดส่งเท่านั้น |
