...
🛑 **ผลกระทบ:** **นี่คือสมมติฐานที่ยังไม่ผ่านการ implement จริงใน P3** — ถ้าคนทำ P3 ตัดสินต่างจากนี้
ต้องกลับมาแก้ query ของ TFR-CC-13 (บันทึกแล้วใน SRS §8 R-2 และ §9 ข้อ 7)
