...
- **รูปเป็นคนละไฟล์ต่อช่องทาง:** LINE ครอบ 1:1 เองจากรูป 1024 JPEG · **Messenger ครอปทุกอย่างที่ไม่ใช่ 1.91:1** (เอกสาร Meta) รูปสินค้าจัตุรัสจะโดนตัดหัวท้ายเกือบครึ่ง จึงประกอบ 1200×628 พื้นขาวด้วย `fit:'contain'` ให้เอง — เห็นของครบสำคัญกว่าเต็มกรอบ
