...
**สิ่งที่ผู้ขายเห็น (S-14b):** แคปชันบรรทัดเดียวข้างปุ่มส่งของเธรด LINE — รวม "ใบนี้ส่งฟรีไหม" กับ "เหลือกี่ข้อความจากเพดานของแพ็กเกจ" ไว้ประโยคเดียว (8 สถานะ ดู `docs/superpowers/specs/2026-08-10-00025-line-quota-meter-design-spec.md`) ปิดช่องพิมพ์เฉพาะเมื่อ **หน้าต่างฟรีปิด + รู้แน่ว่าโควตาหมด** เท่านั้น
