...
| **Flex Message (carousel / การ์ดทั่วไป)** | **แก้มติ 2026-08-11:** เปิดเฉพาะ **การ์ดคำสั่งซื้อ 1 แบบ** (bubble เดี่ยว ปุ่ม `uri` เดียว) เพราะเดิมลูกค้า LINE ได้แค่ข้อความกับลิงก์ดิบ ซึ่งขัดกับมติหลัก "LINE = ทางเข้าของออเดอร์" — **การ์ดสินค้าเปิดแล้วเช่นกัน (2026-08-11 รอบสอง)** — carousel · flex ที่ร้านออกแบบเองยังอยู่นอกขอบเขต |
