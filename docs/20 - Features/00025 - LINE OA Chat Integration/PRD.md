...
| **Flex Message (carousel / การ์ดทั่วไป)** | **แก้มติ 2026-08-11:** เปิดเฉพาะ **การ์ดคำสั่งซื้อ 1 แบบ** (bubble เดี่ยว ปุ่ม `uri` เดียว) เพราะเดิมลูกค้า LINE ได้แค่ข้อความกับลิงก์ดิบ ซึ่งขัดกับมติหลัก "LINE = ทางเข้าของออเดอร์" — **การ์ดสินค้าเปิดแล้วทุกช่องทาง (2026-08-11)** — LINE ใช้ Flex · Messenger/IG ใช้ Generic Template · carousel · flex ที่ร้านออกแบบเองยังอยู่นอกขอบเขต |
| **Quick Reply / Rich Menu** | นอกขอบเขตรอบนี้ — แต่ **ตัวรับ `postback` ทำแล้ว** (2026-08-11) เพราะทั้งสองอย่างส่ง event ชนิดนี้ ปล่อยให้ส่งปุ่มออกไปก่อนแล้วยังไม่มีตัวรับ = ลูกค้ากดแล้วเงียบหาย ซึ่งแย่กว่าไม่มีปุ่ม |
