...
```json
{
  ...
  "used": 52,
  "remaining": 248,
  "fetchedAt": "2569-07-26T10:06:13.000Z",
  "stale": false
}
```
...
| ฟิลด์ | ความหมาย |
|-------|----------|
| `type` | `"limited"` = มีเพดาน, `"unlimited"` = ไม่จำกัด (ฟิลด์ตัวเลขจะเป็น `null`) |
| `remaining` | `total - used` — **ค่าโดยประมาณ** ห้ามนำไปใช้เป็นตัวเลขทางการเงิน |
