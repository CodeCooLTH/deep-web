...
## 11. ภาคผนวก — Phase 2 (2026-07-25): Order Link Trust & Account Linking

> เพิ่มเติมหลังใช้งานจริงบน production เอกสารส่วนนี้ต่อท้าย ไม่แก้เนื้อหา §1–§10 ของ v1.0

### 11.1 ปัญหาที่พบจากการใช้งานจริง

การบังคับล็อกอิน (v1.0) แก้เรื่องการพิสูจน์ตัวตนได้ แต่สร้างปัญหาใหม่สามข้อที่พบเมื่อผู้ซื้อเปิดลิงก์จาก Facebook Messenger จริง

| # | สิ่งที่เกิดขึ้น | ผลต่อผู้ซื้อ |
|---|---|---|
| P-1 | ผู้ซื้อล็อกอินด้วย Facebook แต่ Facebook ไม่ส่งเบอร์โทรมา บัญชีที่เพิ่งสร้างจึงไม่มีเบอร์ ระบบพิสูจน์ความเป็นเจ้าของไม่ได้ | ตกหน้าที่มีทางออกเดียวคือปุ่มออกจากระบบ = เข้าคำสั่งซื้อของตัวเองไม่ได้เลย ทั้งที่ทำตามที่ระบบบอกทุกขั้น |
| P-2 | หน้าล็อกอินเปิดด้วยฟอร์มชื่อผู้ใช้และรหัสผ่าน ส่วนปุ่ม Facebook อยู่ล่างสุดใต้เส้นคั่น ต้องเลื่อนจอถึงเห็น | ผู้ซื้อจากแชทแทบทั้งหมดไม่มีบัญชีรหัสผ่าน จึงเจอทางตันตั้งแต่หน้าจอแรก |
| P-3 | หน้าลิงก์ไม่แสดงหลักฐานใด ๆ ว่าร้านมีตัวตนจริง เป็นเพียงการ์ดฟอร์มบนพื้นเทา | ผู้ซื้อที่ไม่รู้จัก Deep มาก่อนอ่านว่าเป็นหน้าหลอกลวง ซึ่งย้อนแย้งกับจุดยืนของผลิตภัณฑ์โดยตรง |

### 11.2 ข้อตัดสินเชิงผลิตภัณฑ์ (เจ้าของผลิตภัณฑ์อนุมัติ 2026-07-25)

| รหัส | ข้อตัดสิน | เหตุผล |
|---|---|---|
| D1 | เบอร์โทรคือแหล่งความจริงเดียวของตัวตน ช่องทางล็อกอินอื่นเป็นเพียงประตูเข้า ไม่ใช่หลักฐานความเป็นเจ้าของคำสั่งซื้อ | สอดคล้องกับกฎเบอร์โทรที่มีอยู่เดิมทั้งระบบ และกับข้อมูลที่ร้านบันทึกไว้ตอนสร้างคำสั่งซื้อ |
| D2 | หลังล็อกอินผ่านช่องทางใดก็ตาม ต้องยืนยันเบอร์ด้วย OTP เสมอก่อนเข้าถึงคำสั่งซื้อ | ตัวตนจาก Facebook ไม่ผูกกับเบอร์ที่ร้านคีย์ จึงพิสูจน์ความเป็นเจ้าของแทนกันไม่ได้ |
| D3 | เมื่อเบอร์ที่ยืนยันเป็นของบัญชีเดิมที่เคยสมัครไว้ ให้เสนอเชื่อมบัญชีในปุ่มเดียว | ไม่ปล่อยให้ผู้ซื้อมีตัวตนซ้อนสองใบ ซึ่งทำให้ประวัติและคะแนนความน่าเชื่อถือกระจัดกระจาย |
| D4 | ห้ามรวมข้อมูลข้ามบัญชีอัตโนมัติ ถ้าบัญชีต้นทางมีข้อมูลอยู่แล้วให้บล็อกและส่งต่อให้แอดมิน | การรวมข้อมูลผิดกู้คืนยากมาก ความเสี่ยงสูงกว่าประโยชน์ที่ได้ในระยะแรก |
| D5 | เบอร์โทรยังคงเปลี่ยนเองไม่ได้ ไม่ผ่อนผัน แต่ต้องเตือนให้ผู้ใช้หยุดอ่านและยืนยันก่อน | กฎเดิมมีผลต่อคะแนนความน่าเชื่อถือ การผ่อนกฎกระทบทั้งระบบ จึงแก้ที่การสื่อสารแทน |
| D6 | ร้านต้องบันทึกเบอร์ลูกค้าทุกคำสั่งซื้อที่จะส่งลิงก์ | ปิดช่องที่คำสั่งซื้อไม่มีเบอร์ให้เทียบ ซึ่งทำให้ใครก็ตามที่ได้รับลิงก์ต่อยึดเป็นเจ้าของได้ |
| D7 | ข้อมูลที่แสดงก่อนล็อกอิน: ภาพหน้าปกร้าน โปรไฟล์ร้าน หลักฐานความน่าเชื่อถือ ยอดเงิน เลขที่ และวันที่ **แสดงได้** ส่วนรายการสินค้า **ห้ามแสดง** | ผู้ที่ยังไม่ยืนยันตัวตนคือคนที่ถือลิงก์อยู่ในมือ ซึ่งอาจได้รับต่อมา รายการสินค้าเป็นข้อมูลที่ผู้ซื้อไม่อยากให้คนอื่นเห็น ส่วนข้อมูลร้านเป็นข้อมูลสาธารณะอยู่แล้ว |

### 11.3 หลักการนำเสนอความน่าเชื่อถือ

หน้าลิงก์คำสั่งซื้อยกร้านค้าขึ้นเป็นภาพนำก่อนขอให้ล็อกอิน โดยแสดงเฉพาะหลักฐานที่มีอยู่จริงในระบบ

- ป้ายยืนยันตัวตนต้องบอก **ระดับ** ที่ยืนยันถึง (เบอร์ / เอกสาร / จดทะเบียนธุรกิจ) ไม่ใช่คำว่ายืนยันแล้วลอย ๆ ร้านที่ยืนยันแค่เบอร์ต้องไม่ได้ป้ายเดียวกับร้านที่จดทะเบียนธุรกิจ
- ชื่อเพจ Facebook และ Instagram ที่ร้านเชื่อมไว้ถือเป็นหลักฐานที่หนักที่สุดในหน้านี้ เพราะผู้ซื้อเพิ่งสนทนากับเพจนั้นก่อนกดลิงก์
- แสดงความเห็นรีวิวจริงหนึ่งรายการที่มีข้อความ แทนการแสดงเพียงค่าเฉลี่ย
- **ร้านที่ยังไม่มีประวัติให้ซ่อนแถบสถิติทั้งแถบ ห้ามแสดงเลขศูนย์ และห้ามสร้างตัวเลขที่ไม่มีที่มา** ข้อนี้เป็นข้อบังคับ ไม่ใช่ทางเลือกของผู้ออกแบบ

### 11.4 ผลลัพธ์และงานที่ยังค้าง

สถานะ ณ 2026-07-25: ข้อ D1–D7 ลงโค้ดครบและขึ้น production แล้ว

**ยังไม่เสร็จ**
- ยังไม่มีการทดสอบด้วยเบราว์เซอร์จริงในหน้าต่างในแอป Messenger แม้แต่ครั้งเดียว ทั้งหมดผ่านเพียงการตรวจชนิดข้อมูล การทดสอบหน่วย และการตรวจกฎด้วย grep — **โดยเฉพาะยังไม่ได้พิสูจน์ว่า OAuth ของ Facebook ทำงานสำเร็จภายในหน้าต่างในแอปของ Messenger**
- ตัวชี้วัดใน §8 ยังไม่ได้เก็บค่าหลังการเปลี่ยนแปลงนี้
