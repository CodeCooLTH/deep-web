...
## ภาคผนวก — Phase 2 (2026-07-25): ทิศทาง "หน้าร้าน"

เจ้าของผลิตภัณฑ์ตรวจหน้าจอจริงแล้วไม่ผ่าน เพราะเป็นการ์ดแบบฟอร์มลอยบนพื้นเทาซึ่งอ่านว่าเป็นหน้าหลอกลวง จึงเสนอสามทิศทางให้เลือกและได้ข้อสรุปเป็นทิศทาง "หน้าร้าน"

**ไฟล์ประกอบ**
- `docs/superpowers/specs/2026-07-25-order-link-directions.html` — สามทิศทางเทียบกัน
- `docs/superpowers/specs/2026-07-25-order-link-trust-flow-mockup.html` — ทิศทางที่เลือก ครบทุกขั้นตอน สามขนาดจอ

**สาระสำคัญของทิศทางที่เลือก**

ภาพร้านเต็มความกว้างเปิดหน้า ชื่อร้านและสถิติวางทับบนภาพ แผ่นเนื้อหาเลื่อนขึ้นทับแบบแอปจริง ขั้นที่เป็นแบบฟอร์มยุบภาพลงเพื่อคืนพื้นที่ให้ช่องกรอกแต่ยังคงบริบทว่ากำลังทำรายการกับร้านใด บนจอกว้างภาพย้ายไปเป็นคอลัมน์ซ้ายเต็มความสูง เพราะการเรียงลงยาวจะดันปุ่มตกใต้ขอบจอโดยไม่จำเป็น

**หลักที่ได้จากการค้นคว้าและนำมาใช้จริง**
- สัญญาณความน่าเชื่อถือต้องอยู่ตรงจุดที่ผู้ใช้ลังเล จึงวางข้อความอธิบายไว้ติดปุ่มและติดช่องกรอกเบอร์ ไม่ใช่ท้ายหน้า
- ความเฉพาะเจาะจงชนะปริมาณ จึงแสดงความเห็นรีวิวจริงหนึ่งรายการแทนการแสดงเพียงค่าเฉลี่ย
- ป้ายยืนยันต้องบอกระดับที่ยืนยันถึง ไม่ใช่คำว่ายืนยันแล้วลอย ๆ
- บอกจำนวนขั้นตอนล่วงหน้าเพื่อลดความอึดอัดของกระบวนการหลายขั้นบนมือถือ

**ข้อจำกัดที่ต้องรู้**

พื้นที่ใช้งานจริงในหน้าต่างในแอปของ Messenger เหลือประมาณ 390 คูณ 570 จุดภาพ เพราะแถบบนและล่างของแอปกินพื้นที่ไป ทุกทางเข้าสู่ระบบต้องอยู่เหนือขอบนี้

**สิ่งที่ยังไม่ได้ทำ**

ยังไม่ได้ตรวจด้วยเบราว์เซอร์จริงในหน้าต่างในแอปแม้แต่ครั้งเดียว
