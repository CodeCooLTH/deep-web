...
| **~~เสียง / วิดีโอ / ไฟล์แนบทั่วไป~~ → รองรับแล้วบางส่วน (2026-07-23)** | **ขาเข้ารองรับแล้ว** (FR-FBC-17): วิดีโอ/เสียง/ไฟล์ที่ลูกค้าส่งมาถูก mirror เข้า storage ของ Deep แล้วเปิดดู/ฟัง/ดาวน์โหลดได้ในเธรด — **ขาออกยังไม่รองรับ** ร้านยังส่งได้เฉพาะ TEXT และ IMAGE เท่านั้น |
