...
| FR-CMT-08 | ค้นหาคอมเมนต์ได้ (ข้อความ + ชื่อผู้คอมเมนต์) | user ยืนยัน 2026-08-03 — ขอบเขตการค้นคือคอมเมนต์ของร้านตัวเองเท่านั้น |
| FR-CMT-09 | ตอนเชื่อมครั้งแรก ดึงโพสต์ย้อนหลัง 30 วันที่มีคอมเมนต์ (สูงสุด 25 โพสต์) | คอมเมนต์ในโพสต์โหลดตอนกดเปิด ครั้งละ 30 (ดู BRD §8.1) |
