...
#### FR-INS-029: ผลตรวจขั้นที่ 4 ผูกกับที่พักรายหลัง ไม่ครอบทั้งร้าน

**User Story:**
> ในฐานะผู้เยี่ยมชมที่กำลังจะจองบ้านพักหลังหนึ่ง ฉันต้องการรู้ว่าผู้ตรวจของ Deep ไปดู **หลังที่ฉันกำลังจะจอง** จริงหรือไม่ ไม่ใช่ไปดูหลังอื่นของร้านเดียวกันแล้วเหมาว่าทุกหลังผ่าน

**Acceptance Criteria:**
- [ ] AC-INS-29-1: ข้อตรวจของขั้นการตรวจสอบที่ 1 ถึง 3 ผูกกับร้าน ผลตรวจของข้อเหล่านี้ใช้ร่วมกันได้กับที่พักทุกหลังของร้านนั้น
- [ ] AC-INS-29-2: ข้อตรวจของขั้นการตรวจสอบที่ 4 ผูกกับที่พักรายหลัง ผลตรวจปรากฏเฉพาะบนที่พักหลังที่ผู้ตรวจไปยืนตรวจจริงเท่านั้น
- [ ] AC-INS-29-3: ที่พักหลังอื่นของร้านเดียวกันที่ยังไม่เคยถูกตรวจขั้นที่ 4 ต้องแสดงสถานะ "ยังไม่มีข้อมูล" สำหรับข้อตรวจของขั้นที่ 4 ห้ามสืบทอดผลตรวจ "ผ่าน" จากหลังที่ตรวจแล้ว และห้ามแสดงเป็น "ไม่ผ่าน"
- [ ] AC-INS-29-4: ร้านที่ต้องการผลตรวจขั้นที่ 4 บนที่พักมากกว่าหนึ่งหลัง ต้องขอตรวจแยกรายหลัง โดยแต่ละหลังมีรอบตรวจ วันที่ และอัลบั้มภาพของตัวเองแยกจากกัน

**ประเด็นที่ยังเปิดอยู่ (ต้องเคาะก่อนเข้า SRS):**
ข้อตรวจ "วิดีโอคอลนำชมสด" ของขั้นที่ 3 เป็นการตรวจ **สถานที่** เช่นเดียวกับขั้นที่ 4 แต่ตามมติปัจจุบันถูกจัดให้ผูกกับร้านตาม AC-INS-29-1 ⇒ ร้านที่นำชมเพียงหลังเดียวจะได้ผลตรวจ "เห็นของจริง" ครอบทุกหลัง ต้องตัดสินว่าคงตามนี้ หรือเปลี่ยนหลักการผูกจาก "ตามขั้น" เป็น "ตามสิ่งที่ข้อนั้นตรวจ"
...
- ✅ ผลตรวจขั้นที่ 4 ปรากฏเฉพาะหลังที่ผู้ตรวจไปถึงจริง (FR-INS-029)
...
- ข้อตรวจของขั้นที่ 1-3 ผูกกับร้าน ใช้ร่วมกับที่พักทุกหลังของร้านนั้นได้
- ข้อตรวจของขั้นที่ 4 ผูกกับที่พักรายหลัง ห้ามให้ผลตรวจของหลังหนึ่งครอบไปถึงหลังอื่น เพราะขั้นที่ 4 เป็นการยืนยันสถานที่ ไม่ใช่การยืนยันร้าน
- ที่พักที่ยังไม่เคยถูกตรวจขั้นที่ 4 แสดง "ยังไม่มีข้อมูล" เสมอ ไม่ใช่ "ไม่ผ่าน"
