...
| **ผู้จอง / ผู้เข้าพัก** | เปิดลิงก์ ดูรายละเอียด แนบสลิป เปิดใบจอง | เข้าถึงได้ด้วยลิงก์สาธารณะ ไม่ต้องเข้าสู่ระบบ |
...
**Acceptance Criteria:**
- [ ] ยกเลิกการจองได้ พร้อมระบุเหตุผล
...
**Acceptance Criteria:**
- [ ] เปิดลิงก์ได้โดยไม่ต้องเข้าสู่ระบบ
...
**Acceptance Criteria:**
- [ ] ใบจองเข้าถึงได้จากลิงก์สาธารณะเดิมของการจอง ไม่ต้องเข้าสู่ระบบ
...
- [ ] ผู้จองเปิดลิงก์และแนบสลิปได้โดยไม่ต้องเข้าสู่ระบบ
...
3. เจ้าของเห็นรายการนี้ในกลุ่ม "ยังไม่ยืนยัน" จึงกดยกเลิกพร้อมระบุเหตุผลว่าลูกค้าไม่โอน
4. ระบบถามยืนยันก่อนทำจริง เจ้าของยืนยัน
5. ปฏิทินปล่อยคิวคืนทันที ลิงก์เดิมแสดงสถานะยกเลิก

**ผลลัพธ์ที่คาดหวัง:** คิวกลับมาว่าง ไม่มีการปล่อยคิวอัตโนมัติเกิดขึ้นเองโดยที่เจ้าของไม่ได้สั่ง
