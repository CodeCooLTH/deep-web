...
สร้างการจอง — กรอกเบอร์ 08x-xxx-1234
  ...
  เบอร์นี้มีประวัติการจองที่ถูกยกเลิก 3 ครั้ง
  (ผู้จองไม่โอน 2 / ผู้จองขอยกเลิก 1)

  [ สร้างการจองต่อ ]   ← กดได้ปกติ ไม่ถูกบล็อก
```

> **น้ำเสียงของข้อความนี้ (Impeccable):** เขียนแบบ**เป็นกลางและเป็นข้อเท็จจริง** — บอกว่า "มีประวัติการจองที่ถูกยกเลิก" ไม่ใช่ตัดสินคนว่า "ลูกค้ารายนี้ชอบเบี้ยว" เพราะผู้จองไม่มีโอกาสชี้แจงในหน้านี้ และแพลตฟอร์มนี้ขายความน่าเชื่อถือ ไม่ใช่การประจาน
