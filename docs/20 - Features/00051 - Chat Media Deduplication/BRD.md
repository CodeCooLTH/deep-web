...
- "เนื้อไฟล์เหมือนกัน" ในเอกสารนี้หมายถึง **เหมือนกันทุกบิต (bit-identical)** — **ยืนยันกับ user แล้ว (2026-08-19): ไฟล์ที่ต่างกันแม้เพียงเล็กน้อยให้ถือเป็นคนละรูป และเก็บแยกกันตามปกติ** เหตุผลคือกันไม่ให้รวมไฟล์คนละเนื้อหาเข้าด้วยกันผิดพลาด (false-positive) และคาดว่ากรณีรูปเดิมที่ถูก re-encode/crop จากต้นทางจนบิตไม่ตรงจะมีจำนวนไม่มากพอที่จะคุ้มกับความเสี่ยงของการเทียบแบบ "คล้ายกัน"
...
- สิทธิ์สั่งรัน/อนุมัติกระบวนการย้อนหลังจำกัดเฉพาะทีมงาน Deep ระดับระบบเท่านั้น — **ยืนยันกับ user แล้ว (2026-08-19): รันผ่าน script/CLI ที่ทีมงานรันเองได้ ไม่ต้องทำหน้าจอ admin** ดังนั้นทั้ง dry-run และการรวมไฟล์จริงต้องสั่งงานผ่าน command line ได้ครบทุกขั้น พร้อมพิมพ์รายงานผลออกมาให้อ่านได้ทันทีในเทอร์มินัล
