...
```jsonc
{
  ...
  "capacity": 8,
  "busy": [
    { "start": "2026-08-03T09:00:00+07:00", "end": "2026-08-03T10:00:00+07:00", "booked": 8 },
    { "start": "2026-08-03T10:00:00+07:00", "end": "2026-08-03T11:00:00+07:00", "booked": 3 }
  ]
}
```
...
**Response 201** — โครงเดิม + `appointment` object

**Errors ที่เพิ่ม:** `403 FEATURE_NOT_AVAILABLE`, `409 APPOINTMENT_SLOT_FULL`, `400` เวลาไม่ถูกต้อง
...
// 409 APPOINTMENT_SLOT_FULL — ข้อความระดับธุรกิจ ไม่มีคำว่า "ที่นั่ง" และไม่มีข้อความดิบจาก Postgres
{
  ...
  "capacity": 8,
  "start": "2026-08-03T09:00:00+07:00",
...
| Status | Code | เมื่อไหร่ |
|--------|------|----------|
| 401/403 | ตามกติกา feature 00015 | ยังไม่ login / ไม่ใช่เจ้าของออเดอร์ |
| 404 | `APPOINTMENT_NOT_FOUND` | ออเดอร์นี้ไม่มีนัด |
...
| Endpoint | FR | TFR |
|----------|-----|-----|
| 4.1–4.3 ทรัพยากร | FR-RSV-01 | TFR-001, TFR-003 |
| 4.4 availability | FR-RSV-03 | TFR-005 |
| 4.5 ปฏิทิน | FR-RSV-04 | TFR-008, TFR-010, TFR-012 |
| 4.6 สร้างออเดอร์พร้อมนัด | FR-RSV-03 | TFR-002, TFR-004 |
