...
| **D-RM-2** | รอบแรก **ใช้เทมเพลตอย่างเดียว** ร้านอัปโหลดภาพเองไม่ได้ | ตัดงานทำตัวกำหนดพิกัดปุ่มบนภาพออกจากรอบนี้ · ร้านที่มีภาพของตัวเองยังไปทำที่ OA Manager ได้ (แต่ต้องไม่เปิดของเราทับ) |
