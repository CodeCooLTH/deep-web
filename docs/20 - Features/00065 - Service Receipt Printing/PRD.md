...
> **มติ 2026-09-24 (หลังขึ้น prod):** สีเน้นของใบเสร็จ (หัว/ป้าย/สามเหลี่ยมเลขหน้า) ใช้**น้ำเงินหลักของ Deep `#236dc9`** ไม่ใช่เขียวของใบ BT Premium — สีเป็นของร้านเดียว ไม่ควรติดไปกับใบของทุกร้าน (user เลือกข้อ ข. จาก 3 ทาง: ขาวดำ / น้ำเงิน Deep / ให้ร้านเลือกสีเอง)
