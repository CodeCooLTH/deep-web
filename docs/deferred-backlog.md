...
มันตัดสิน "เมื่อ**ไม่เข้า**กลุ่มไหนเลยจะทำอะไร" ซึ่งไม่มีกลุ่มให้แขวน ต่างจาก AI Enchant
...
เมื่อคลังไม่มีคำตอบที่ใกล้พอ (เกณฑ์ความมั่นใจขั้นต่ำ) · เกี่ยวกับ AI Enchant ยังไง
