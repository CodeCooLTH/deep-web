 ...
 *
 * 📌 เคยเป็น 3 (ยกมาจาก `showRating: reviewCount >= 3` ที่ /u/[username] ใช้อยู่) ด้วยเหตุผลว่า
 * ค่าเฉลี่ยจากตัวอย่างน้อยเกินไปคือตัวเลขที่ดูน่าเชื่อกว่าความจริง — **user เปลี่ยนเป็น 1 เมื่อ
 * 2026-08-11** ("อยากให้แสดงผลตั้งแต่ 1 review แต่วงเล็บข้างหลัง")
 *
 * สิ่งที่กันความเข้าใจผิดไว้แทนคือ **จำนวนรีวิวในวงเล็บที่ติดอยู่กับดาวเสมอ** — "5.0 (1)" บอก
 * ตัวเองอยู่แล้วว่ามาจากรีวิวเดียว ต่างจาก "5.0" ลอย ๆ ที่อ่านเหมือนร้านคะแนนเต็มจากลูกค้าจำนวนมาก
 * 🛑 ถ้าวันไหนมีคนถอดวงเล็บออกเพื่อความกระชับ ต้องยกเกณฑ์นี้กลับเป็น 3 พร้อมกัน
 */
const RATING_MIN_REVIEWS = 1
  ...
  return (
    <div className='is-full'>
      ...
      {data.badges.length > 0 && (
        <div className='pli-5 pbs-1 pbe-4 sm:pbs-2 sm:pbe-6'>
      ...
      {/* plb ใหญ่ขึ้นบนจอกว้าง (user 2026-08-11 "เพิ่มระยะห่างระหว่างเหรียญ สถิติ tab") —
          บนเดสก์ท็อปแถบนี้กว้าง 960px แต่สูงเท่ามือถือ จึงอ่านเป็นแถบแบน ๆ ที่ถูกบีบ
          มือถือคงเดิมเพราะที่นั่นความสูงคือสิ่งที่แลกกับการได้เห็นสินค้าในจอแรก */}
      <div className='pli-5 plb-3.5 sm:plb-5 border-bs border-be bg-[var(--mui-palette-background-default)]'>
