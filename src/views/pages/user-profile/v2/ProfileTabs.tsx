        ...
        {tabs.map((t, i) => {
          ...
          return (
            <button
              ...
              onClick={() => setActive(i)}
              className={`relative plb-3 text-[15px] font-semibold whitespace-nowrap bg-transparent border-0 cursor-pointer font-[inherit] inline-flex items-center gap-1.5 ${
