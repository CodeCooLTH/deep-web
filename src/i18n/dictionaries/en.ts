...
export const en: Dictionary = {
  ...
  inbox: {
    ...
    attachSheetTitle: 'Files to send',
    attachSheetClose: 'Close and go back to typing',
    attachSheetAddMore: 'Add files',
    attachSheetSend: 'Send {count}',
    attachSheetCaption: 'This message will be sent too: “{text}”',
