...
export const th = {
  ...
  inbox: {
    ...
    sort: {
      ...
      optionAllDescription: 'เรียงตามข้อความล่าสุดของห้อง ไม่ว่าร้านหรือลูกค้าเป็นคนพิมพ์',
      optionCustomerLatestLabel: 'ข้อความล่าสุดจากลูกค้า',
      // 🛑 ห้ามเขียนว่า "คนที่รอนานที่สุดขึ้นก่อน" — โค้ดเรียง lastInboundAt **desc**
      // (ลูกค้าที่พิมพ์ล่าสุดอยู่บนสุด) ซึ่งเป็นทิศตรงข้ามกับ "รอนานสุดขึ้นก่อน" พอดี
      optionCustomerLatestDescription:
        'เรียงตามข้อความล่าสุดที่ลูกค้าพิมพ์เข้ามา — ร้านตอบแล้วห้องไม่ลอยขึ้น ถ้าลูกค้ายังไม่พิมพ์ต่อ',
    ...
    filterPanel: {
      ...
      // ปุ่ม "ล้างตัวกรอง" อยู่ในกล่องเดียวกันแต่ไม่แตะการเรียง — ต้องบอก ไม่ใช่ให้ผู้ใช้ลองเอง
      sortNotCleared: 'ไม่ถูกล้างพร้อมตัวกรอง',
