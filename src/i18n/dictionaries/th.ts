...
export const th = {
  ...
  /**
   * จอโหลดตอน "เข้าโซนผู้ขายครั้งแรก" — โชว์ครั้งเดียวตอนเปิดเว็บ/เปิดแอป ไม่ใช่ทุกครั้งที่เปลี่ยนหน้า
   * (หัวหน้าเคาะ 2026-08-20: *"เอาแค่หน้าตอนแรกไหม"* — หน้าอื่นคง skeleton ที่เลียนโครงหน้าไว้เหมือนเดิม
   *  เพราะ skeleton รู้สึกเร็วกว่า overlay ทับจอเปล่า)
   *
   * 🛑 ห้ามเอ่ยชื่อร้าน — จอนี้ทำงาน "ก่อน" ระบบ resolve ว่า active อยู่ร้านไหน
   *    (`requireActiveShop` อยู่ใน (dashboard)/layout ซึ่งยังไม่ทำงานตอน fallback นี้แสดง)
   *    การเดาชื่อร้านแล้วกระพริบเปลี่ยนทีหลังแย่กว่าไม่บอกเลย · ชื่อร้านสงวนให้จอ "สลับร้าน" เท่านั้น
   */
  ...
  authCallbackLoading: {
    ...
    /* ข้อความตอนล็อกอินไม่สำเร็จ — แยกตามเจ้าเพื่อให้ผู้ใช้รู้ว่าต้องลองกับปุ่มไหน */
    error: {
      apple: 'เข้าสู่ระบบด้วย Apple ไม่สำเร็จ กรุณาลองใหม่',
      facebook: 'เข้าสู่ระบบด้วย Facebook ไม่สำเร็จ กรุณาลองใหม่',
      line: 'เข้าสู่ระบบด้วย LINE ไม่สำเร็จ กรุณาลองใหม่',
      instagram: 'เข้าสู่ระบบด้วย Instagram ไม่สำเร็จ กรุณาลองใหม่',
      generic: 'เข้าสู่ระบบไม่สำเร็จ กรุณาลองใหม่',
    },
  },
  ...
  comments: {
    ...
    // 🛑 มีเฉพาะแท็บ "หมดอายุ" — คำที่ใช้ต้องไม่ทำให้ใครเข้าใจว่ากดได้กับคิวงานจริง
    resolveAllExpiredButton: 'ทำเครื่องหมายทั้งหมด ({count})',
    resolveAllExpiredButtonBusy: 'กำลังทำเครื่องหมาย…',
    resolveAllExpiredAria: 'ทำเครื่องหมายคอมเมนต์ที่หมดอายุทั้งหมด {count} รายการว่าจัดการแล้ว',
    resolveAllExpiredTitle: 'ทำเครื่องหมายคอมเมนต์ที่หมดอายุทั้งหมด?',
    resolveAllExpiredText:
      'จะทำเครื่องหมาย {count} รายการที่หมดอายุ ({scope}) เป็น "จัดการแล้ว" — ยังตอบใต้คอมเมนต์แบบสาธารณะได้ตามปกติ แค่ทักแชทส่วนตัวไม่ได้แล้ว\n\nยกเลิกทีละรายการได้ทีหลังถ้าต้องการ',
    resolveAllExpiredConfirmBtn: 'ทำเครื่องหมายทั้งหมด',
    resolveAllExpiredToast: 'ทำเครื่องหมาย {count} รายการว่าจัดการแล้ว',
    resolveAllScopeAllPages: 'ทุกเพจที่เชื่อมไว้',
    resolveAllScopePage: 'เพจ {page}',
    resolveAllScopeChannel: 'ช่องทาง {channel}',
    emptyExpiredTitle: 'ไม่มีคอมเมนต์ที่หมดอายุ',
    emptyExpiredDesc: 'คอมเมนต์ที่ยังไม่ตอบทุกใบยังอยู่ในหน้าต่าง 7 วัน ทักแชทได้ตามปกติ',
  ...
  inbox: {
    ...
    /**
     * กองรูปแอดมินที่เข้าไปตอบในห้องนั้น (user สั่ง 2026-09-10) — มุมขวาล่างของแถว
     * 🛑 นับเฉพาะคนที่ตอบ "จากใน Deep" เท่านั้น: ตอบจาก Business Suite/แอปของแพลตฟอร์ม
     * และคำตอบของบอท ไม่มีตัวตนคนส่งติดมา จึงไม่ขึ้นเลย (ดู HUMAN_AGENT_REPLY_WHERE)
     */
    agentsLabel: 'แอดมินที่ตอบในแชทนี้',
    agentsMore: 'และอีก {n} คน',
    channelFilterLabel: 'ตัวกรองช่องทาง',
    channelAll: 'ทั้งหมด',

    /** แท็บย่อยสถานะเหนือรายการแชท + แผงตัวกรอง */
    filters: 'ตัวกรอง',
    // 00018 ext 2026-09-09 — ตัวเลือกการเรียงลำดับกล่องแชท
    sort: {
      // ชื่อต้องอธิบายตัวเองได้ — ไม่มีคำอธิบายใต้ชิปแล้ว (ดูคอมเมนต์ในแผงว่าทำไมถึงตัดออก)
      optionAllLabel: 'ทุกข้อความ',
      optionCustomerLatestLabel: 'ลูกค้าพิมพ์ล่าสุด',
      // สั้นเท่าที่ยังอ่านรู้เรื่อง — ช่องนี้อยู่คอลัมน์ที่ไม่หด ยาวขึ้น = บีบชื่อลูกค้าให้แคบลง
      // 🛑 ต้องระบุประธานว่า "ลูกค้า" — คำว่า "ทัก" ในดิกชันนารีนี้มีประธานเป็น *ร้าน* เสมอ
      // ('ทักแชทส่วนตัว' · 'หมดเวลาทักแชท' · 'ทักแชทได้อีก {remaining}' ในแท็บความคิดเห็นที่อยู่
      // ติดกันแค่คลิกเดียว) ⇒ 'ยังไม่ทัก' เฉย ๆ จะถูกอ่านกลับด้านเป็น "ร้านยังไม่ได้ทัก"
      neverInbound: 'ลูกค้าเงียบ',
      // 00018 ext รอบสอง 2026-09-09 — ปุ่มในแผงตัวกรอง
      saveDefault: 'บันทึกเป็นค่าเริ่มต้น',
      saveDefaultSuccess: 'บันทึกค่าเริ่มต้นแล้ว — เปิดกล่องแชทครั้งหน้าจะได้ชุดนี้ทันที',
      // warning ไม่ใช่ error แดง: สิ่งที่ผู้ใช้เพิ่งสั่งบนจอสำเร็จไปแล้ว พลาดแค่ส่วน "จำไว้ครั้งหน้า"
      saveDefaultWarning: 'ใช้ตัวกรองนี้แล้ว แต่บันทึกเป็นค่าเริ่มต้นไม่สำเร็จ — ลองกดบันทึกอีกครั้ง',
    },
    ...
    /**
     * แถบสถานะ "หน้าต่างเวลาตอบ" เหนือช่องพิมพ์ (ChatThread) — 4 สาขา × short/detail
     * 🛑 `windowStatusHumanAgent*` คือฉากหลักของคลิป E ที่ยื่น Meta App Review (permission Human Agent)
     *    ต้องบอกครบ 3 อย่าง: พ้น 24 ชม. / ตอบได้ถึงเมื่อไร / ต้องพิมพ์เอง ห้ามโปรโมชัน
     * 🛑 `windowStatusExpired*` ห้ามพูดว่า "เกิน 7 วัน" — สาขานี้เข้าได้ทั้งตอนเกิน 7 วันและตอนสวิตช์ระบบปิด
     * `windowStatusHumanAgentDetail` เป็นประโยคเดียวที่มี `{date}` — โค้ด split ตรงนั้นเพื่อทำตัวหนาที่วันที่
     *   (ห้ามแตกเป็น before/after สองคีย์: คนแปลต้องเห็นทั้งประโยค และอังกฤษวางวรรคตอนรอบวันที่ต่างจากไทย)
     */
    windowStatusCommentReplyShort: 'ตอบคอมเมนต์ได้ 1 ข้อความ — รอลูกค้าตอบกลับ',
    ...
    windowStatusNeverInboundShort: 'ลูกค้ายังไม่เคยทักเข้ามา — อาจส่งไม่สำเร็จ',
    ...
    windowStatusHumanAgentShort: 'เกิน 24 ชั่วโมงแล้ว — ตอบเองได้ ห้ามส่งโปรโมชัน',
    windowStatusHumanAgentDetail: 'เกิน 24 ชั่วโมงแล้ว แต่ยังตอบเองได้ถึง {date} — ต้องเป็นข้อความที่พิมพ์เอง ห้ามส่งโปรโมชัน (นโยบาย Meta)',
    windowStatusHumanAgentFallbackExpiry: '7 วันนับจากข้อความล่าสุดของลูกค้า',
    windowStatusExpiredShort: 'เกินเวลาที่ Meta ให้ตอบ — อาจส่งไม่สำเร็จ',
    ...
    customerPanel: {
      ...
      /**
       * ขอบเขตของรายการในแท็บนี้ (2026-09-05) — รายการนับ "ของลูกค้าที่ผูกอยู่ **หรือ** ที่เปิด
       * จากห้องนี้" ส่วนตัวเลขบนแท็บ/บล็อกสรุปนับ "ของลูกค้า" อย่างเดียว สองอันจึงต่างกันได้
       * โดยไม่มีอะไรผิด — ประโยคนี้ตั้งความเข้าใจไว้ล่วงหน้าแทนที่จะให้ผู้ขายเดาว่าตัวนับพัง
       */
      listScopeNote: 'รวมทุก{noun}ที่เปิดจากห้องนี้ อาจมากกว่ายอดในแท็บ "ข้อมูลลูกค้า"',
      notLinkedNoHistory:
  ...
  publicProfile: {
    ...
    /** การ์ดสวิตช์ราคา (feature 00053 — PriceVisibilityToggleClient) */
    prices: {
      cardTitle: 'ราคาบนหน้าร้าน',
      switchLabel: 'แสดงราคาบนหน้าร้านสาธารณะ',
      descriptionOn: 'ลูกค้าเห็นราคาสินค้า ห้องพัก และมัดจำบริการบนหน้าร้านของคุณ',
      descriptionOff:
        'หน้าร้านจะไม่แสดงตัวเลขราคาใด ๆ — ยอดสะสมของแต่ละรายการ (เช่น ใช้บริการแล้ว 3 ครั้ง) ยังแสดงตามปกติ',
      hiddenBanner: 'ราคาถูกซ่อนอยู่ตอนนี้ ลูกค้าที่เปิดหน้าร้านจะไม่เห็นตัวเลขราคา',
      saveError: 'ไม่สามารถเปลี่ยนการแสดงราคาได้',
      shownToast: 'แสดงราคาบนหน้าร้านแล้ว',
      hiddenToast: 'ซ่อนราคาบนหน้าร้านแล้ว',
    },

    /** การ์ดเลือกรายการที่แสดงบนหน้าร้าน (feature 00053 — ProfileItemVisibilityClient) */
    itemVisibility: {
      cardTitle: 'รายการที่แสดงบนหน้าร้าน',
      subtitle: 'ปิดสวิตช์เพื่อไม่ให้รายการนั้นขึ้นหน้าร้าน — ยังขายผ่านแชทและหน้าสร้างคำสั่งซื้อได้ตามปกติ',
      searchPlaceholder: 'ค้นหาชื่อ',
      countLabel: 'แสดงอยู่ {visible} จาก {total}',
      groupProduct: 'สินค้า',
      groupRoom: 'ห้องพัก',
      groupService: 'บริการ',
      pinnedBadge: 'ปักหมุด',
      hiddenTag: 'ซ่อนอยู่',
      chipAll: 'ทั้งหมด {n}',
      chipShown: 'แสดงอยู่ {n}',
      chipHidden: 'ซ่อนอยู่ {n}',
      showAll: 'แสดงทั้งหมด',
      hideAll: 'ซ่อนทั้งหมด',
      showMore: 'ดูทั้งหมด ({n})',
      hideAllConfirmTitle: 'ซ่อนทุกรายการจากหน้าร้าน?',
      hideAllConfirmBody:
        'ลูกค้าที่เปิดหน้าร้านจะไม่เห็นรายการเหล่านี้เลย — คุณยังขายผ่านแชทและหน้าสร้างคำสั่งซื้อได้ตามปกติ และเปิดกลับได้ทุกเมื่อ',
      noResults: 'ไม่พบรายการที่ค้นหา',
      saveError: 'บันทึกไม่สำเร็จ ลองใหม่อีกครั้ง',
      shownToast: 'แสดงบนหน้าร้านแล้ว',
      hiddenToast: 'ซ่อนจากหน้าร้านแล้ว',
    },
  ...
  auth: {
    signIn: {
      ...
      /**
       * ห้ามผูกกับวิธีล็อกอินวิธีใดวิธีหนึ่ง — จอนี้มีทั้งรหัสผ่าน เบอร์โทร (OTP) และโซเชียล
       * เดิมเขียนว่า "กรอกชื่อผู้ใช้และรหัสผ่าน" ซึ่งกลายเป็นคำโกหกทันทีที่ผู้ใช้สลับไปโหมด OTP
       * (subtitle อยู่ใน page.tsx ซึ่งเป็น server component จึงอ่านสถานะโหมดของฟอร์มไม่ได้)
       */
      ...
      /**
       * ทางเข้าด้วยเบอร์โทร (OTP) — มีไว้ให้บัญชีที่สมัครด้วย OTP ล้วนและไม่เคยตั้งรหัสผ่าน
       * ซึ่งก่อนหน้านี้เข้าฝั่งผู้ขายไม่ได้เลยสักทาง. รหัสเหตุผลของ `otp*` ตรงกับ
       * `SigninOtpFailReason` ใน `seller/auth/components/send-signin-otp.ts` — เพิ่มค่าใหม่ที่นั่น
       * ต้องเติมคำที่นี่และใน `en.ts` ด้วย
       */
      orPhone: 'หรือเข้าด้วยเบอร์โทร',
      phoneLabel: 'เบอร์โทรศัพท์',
      errPhoneRequired: 'กรุณากรอกเบอร์โทร',
      sendOtp: 'ส่งรหัส OTP',
      sendingOtp: 'กำลังส่งรหัส...',
      otpSendError: 'ส่งรหัส OTP ไม่สำเร็จ กรุณาลองใหม่',
      otpRateLimited: 'คุณส่งคำขอบ่อยเกินไป กรุณารอสักครู่',
      /** ต่างจาก errInvalidCredentials โดยตั้งใจ — ตรงนี้บอกได้ เพราะมีทางออกที่ผู้ใช้ทำต่อได้จริง */
      otpNoAccount: 'เบอร์นี้ยังไม่มีบัญชี Deep',
      useOtpInstead: 'เข้าสู่ระบบด้วยเบอร์โทรแทน',
      /**
       * แสดงใต้ error ล็อกอินผิดเท่านั้น — บัญชีที่สมัครด้วย OTP ล้วนจะตกมาที่ error นั้นเสมอ
       * ข้อความเป็นข้อเสนอทั่วไป ไม่ยืนยันว่า username ที่กรอกมีอยู่จริง จึงไม่เปิดช่อง enumeration
       */
      noPasswordUseOtp: 'ยังไม่เคยตั้งรหัสผ่าน? เข้าสู่ระบบด้วยเบอร์โทรแทน',
      usePasswordInstead: 'เข้าสู่ระบบด้วยรหัสผ่านแทน',
      /**
      ...
      oauthError: {
        ...
        noSellerAccountInApp: 'ไม่พบบัญชีผู้ขายสำหรับข้อมูลที่ใช้เข้าสู่ระบบนี้',
        /* คนละเคสกับข้างบน — คนนี้ *มีบัญชีอยู่แล้ว* แค่ยังตั้งค่าร้านไม่เสร็จ ห้ามบอกว่าไม่พบบัญชี */
        sellerSetupIncompleteInApp: 'บัญชีนี้ยังตั้งค่าร้านค้าไม่เสร็จ จึงยังใช้งานในแอปไม่ได้',
        /* next-auth เด้งกลับพร้อม ?csrf=true เมื่อคุกกี้ยังไม่พร้อม — เดิมเงียบสนิท ผู้ใช้อ่านว่า "กดแล้วไม่ไปไหน" */
        csrfNotReady: 'ยังเตรียมข้อมูลเข้าสู่ระบบไม่เสร็จ กรุณากดอีกครั้ง',
      },
    },
  },
