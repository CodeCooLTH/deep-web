...
export const th = {
  ...
  /** จอที่ขึ้นแทนฟอร์มลงทะเบียนเมื่อเปิดจากในแอป iOS (Apple Guideline 3.1.1, 2026-08-23)
   *  🛑 ห้ามใส่ลิงก์/ปุ่มไปเว็บในข้อความนี้ — Apple ถือว่าการลงทะเบียนคือ "external mechanism" */
  appSetupBlocked: {
    title: 'ตั้งค่าบัญชีให้เสร็จก่อนใช้งาน',
    body: 'บัญชีนี้ยังลงทะเบียนไม่เสร็จ กรุณาลงทะเบียนและตั้งค่าร้านให้เรียบร้อยผ่านเว็บไซต์ของเรา แล้วกลับมาเข้าสู่ระบบในแอปอีกครั้ง',
    signOut: 'ออกจากระบบ',
  },
}
