...
export const th = {
  ...
  inbox: {
    ...
    customerPanel: {
      ...
      tabCustomer: 'ข้อมูล',
      /**
       * หัวกล่องยุบได้ของแผงข้อมูลลูกค้า (V1 · 2026-08-18) — **ไม่ใช่คำบนแท็บ** จึงใช้คำเต็มได้
       * ต่างจากคีย์ `tab*` ด้านบนที่ต้องสั้นเพราะเรียงกัน 4 อันในแถบกว้าง 384px
       * "ติดต่อ" ครอบชื่อในแชท/ชื่อจริง/เบอร์ — คำที่ตอบว่า "จะติดต่อคนนี้ยังไง" ตรงกว่า "ข้อมูล"
       */
      foldContact: 'ติดต่อ',
      foldTags: 'แท็กและสถานะ',
      foldAddress: 'ที่อยู่',
      /** หัวกล่องตอนกำลังแก้ไข — ฟอร์มเดียวครอบทั้ง 3 กล่อง จึงต้องพูดกว้างกว่าชื่อกล่องใดกล่องหนึ่ง */
