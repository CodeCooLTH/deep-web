/**
 * product-sales-month — SSOT ของรายงาน "ยอดขายรายสินค้า" (feature 00062)
 *
 ...
 */
export const SALES_BASIS_NOTE =
  'นับจากออเดอร์ที่ยังไม่ถูกยกเลิก (รวมออเดอร์ที่ลูกค้ายังไม่กดยืนยัน) — เกณฑ์เดียวกับ "สั่งซื้อแล้ว" ในหน้าสินค้า ไม่ใช่ยอดขายที่ยืนยันแล้วแบบหน้า "ภาพรวมกำไร/ขาดทุน"'
 ...
 *
 * ทำไมไม่ส่ง array เต็ม 31 ช่อง: หน้านี้ต้องส่งอนุกรมของสินค้า **ทุกตัว** ลง client
 * เพื่อให้ติ๊กสลับเส้นบนกราฟได้โดยไม่ยิง API (มติข้อ 5 ไม่มี endpoint ใหม่)
 * ร้านที่มีสินค้าเป็นร้อยตัวส่วนใหญ่ขายได้ไม่กี่วันต่อเดือน ⇒ การส่งเลขศูนย์ 28 ตัวต่อสินค้า
 * คือ payload ที่จ่ายไปกับความว่างเปล่า
 */
