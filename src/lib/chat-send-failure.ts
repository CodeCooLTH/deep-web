...
const RULES: Rule[] = [
  ...
  // สองสำนวนสำหรับเรื่องเดียวกัน) ⇒ route ถูกแก้ให้มาอ่านจากที่นี่แทนการ hardcode ในคอมมิตเดียวกัน
  {
    ...
    text: 'ไม่มีสิทธิ์เข้าถึงบทสนทนานี้',
    retryable: false,
  },
  {
