 ...
 *   `/b` กับ `/u` ประกอบเองด้วย div มาตลอด ⇒ 6px ในตารางนี้ไม่ใช่ "ค่าการ์ด" อีกต่อไป
 *   2 (12px) = กล่องข้อความ/กล่องสถิติ (ค่าหลัก) · พิลเขียนเป็น '9999px' ตรง ๆ ไม่ใช่ 999
 *   (2.25 = 13.5px ถูกถอดออก 2026-08-30 — รูปย่อสินค้าลงบันได 8px ตาม DESIGN.md แล้ว)
 *
 * 🛑 แดง = ห้าม merge
 */
