...
/**
 * ชื่อที่แสดงแทน "ผู้ตรวจ" ของข้อตรวจอัตโนมัติ (ผลที่ไม่มีรอบผูกอยู่)
 * 🛑 ห้ามปล่อยว่าง — หน้าจอที่ render ชื่อจะได้ค่าว่างแล้วดูเหมือนข้อมูลหาย ทั้งที่ความจริงคือ
 *    "ระบบเป็นคนตรวจ" ซึ่งเป็นคำตอบที่สมบูรณ์ (SRS TFR-011)
 */
export const SYSTEM_INSPECTOR_NAME = 'ระบบตรวจอัตโนมัติของ Deep'
