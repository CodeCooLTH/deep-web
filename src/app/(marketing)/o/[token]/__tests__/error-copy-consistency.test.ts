...
const ALLOWED_TAILS = [
  ...
  // feature 00062 — คัดลอก "เลขบัญชี" ไม่ใช่ "เลขพัสดุ" คนละบริบท ห้ามยุบรวมกับ tail ข้างบน
  // (ผู้ใช้ที่เจอทั้งสองข้อความในหนึ่งเซสชันต้องรู้ว่ากดค้างตรงไหน — "เลขพัสดุ" ผิดที่จะสับสน)
  'กดค้างที่เลขบัญชีเพื่อคัดลอกเองได้',
  // feature 00062 — บันทึกรูป QR ล้มเหลวไม่ใช่เรื่องที่ "ลองใหม่" แล้วจะได้เช่นกัน (canvas
  // export ล้มเหลวมักเป็นข้อจำกัดของเบราว์เซอร์/อุปกรณ์ ไม่ใช่ปัญหาเครือข่ายชั่วคราว)
  'ลองแคปหน้าจอแทนได้',
]
