      ...
      >
        ...
        <Box
          sx={{
            bgcolor: 'background.paper',
            ...cardInlinePadSx,
            /* 20px เท่ากับขอบในของการ์ดใบอื่น — บล็อกนี้เป็น *บล็อกแรก* ของการ์ด
               ระยะบนของมันคือระยะบนของการ์ดในสายตาผู้ใช้ */
            pt: 5,
            [ORDER_TWO_COL_MQ]: {
              /* 20px = ระยะขอบในของการ์ดทั้งหน้า (`cardBodySx`) — บล็อกที่ซ้อนในการ์ดใบเดียว
        ...
        {/* 🛑 `pb: 5` = 20px เท่ากับขอบในของการ์ด — บล็อกนี้เป็น **บล็อกสุดท้าย** ของการ์ด
        ...
        >
          ...
          <Card>
             ...
             */}
            <Box sx={{ ...cardInlinePadSx, pb: 5, pt: 0.5 }}>
              <Box
                sx={{
                  ...infoBoxSx,
                  borderRadius: 2,
