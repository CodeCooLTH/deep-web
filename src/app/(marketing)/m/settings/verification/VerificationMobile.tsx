...
const Card = ({
  ...
  <div className='rounded-2xl bg-[var(--mui-palette-background-paper)] border border-[var(--mui-palette-divider)] flex flex-col gap-3 p-5'>
...
export default function VerificationMobile({ phoneVerified, records }: Props) {
  ...
  const UploadRow = ({
    ...
    <div className='flex items-center gap-3 rounded-2xl border border-[var(--mui-palette-divider)] p-5'>
