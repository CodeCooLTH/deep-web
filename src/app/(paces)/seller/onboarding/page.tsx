 ...
 * เด้งจาก proxy เมื่อ token.needsOnboarding (ไม่มี slug). ผ่าน /dashboard มาแล้ว = รู้สึกเข้าระบบแล้ว
 *
 * Base (layout): AuthCardShell · Base (field): SignUpForm.tsx (input-icon-group/ChoiceSelect/invalid-msg)
 * Flow: 1.หมวดหมู่ (ChoiceSelect) → 2.URL ร้าน (slug) → 3.ที่อยู่ (address) → 4.สินค้าแรก → /dashboard
