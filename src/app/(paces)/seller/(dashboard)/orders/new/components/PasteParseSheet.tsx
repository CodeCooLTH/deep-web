...
export default function PasteParseSheet({ open, onApply, onClose }: Props) {
  ...
  return (
    <>
      ...
      {/* HR7: fixed inset-x-0 bottom-0 = viewport-lock */}
      <div
      ...
      >
        ...
        <div className="px-5 pt-1 pb-[calc(1rem+env(safe-area-inset-bottom))]">
          <h3 className="text-base font-semibold text-dark">วางข้อความจากแชท</h3>
          <p className="mt-0.5 mb-3 text-xs text-default-400">ระบบแยก ชื่อ / เบอร์ / ที่อยู่ ให้อัตโนมัติ (ตรวจแล้วแก้ได้)</p>
          ...
          <button
            ...
            className="btn mt-3 min-h-11 w-full bg-primary font-semibold text-white hover:bg-primary-hover disabled:opacity-50"
          >
            แยกข้อมูล → เติมให้
          </button>
        </div>
