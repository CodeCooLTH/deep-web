    ...
    <div className="flex flex-col gap-4">
        ...
        {value.date && !value.resourceId && (
          <div className="bg-warning/10 border-warning/30 rounded-lg border p-3">
            <p className="text-default-800 text-sm font-medium">
              {/* ชี้ชื่อ control ที่อยู่ "ด้านล่าง" ให้ตรง — ฟิลด์นั้น label ว่า "บริการ"
                  (user เคาะเอง 2026-08-07 เปลี่ยนจาก "รับนัดโดย") ผู้ใช้กวาดตาหาคำว่า
                  "ประเภทงาน" แล้วไม่เจอ · และเลี่ยงคำว่า "ยืนยัน" ซึ่งชนกับสถานะ
                  APPOINTMENT_STATUS_LABEL.CONFIRMED_BY_BUYER ("ลูกค้ายืนยันแล้ว") ที่โผล่
                  บนป้ายของแถวนัดในจอเดียวกัน — และการเลือกบริการยังไม่ได้ยืนยันอะไรจริง
                  ต้องกดบันทึกออเดอร์อีกที */}
              {prefilledFromCalendar ? 'เลือกประเภทงานเพื่อบันทึกวันนัด' : 'ยังไม่ได้เลือกประเภทงาน'}
            </p>
        ...
        <div>
          <div className="mb-2 flex items-center justify-between gap-2">
            ...
            <span id={`${idPrefix}-appt-resource-label`} className="form-label mb-0">ประเภทงาน</span>
            ...
            {byDay && (
              <div className="bg-info/10 text-info-ink flex items-start gap-2 rounded-lg px-3 py-2 text-xs">
                ...
                {/* "หน้า คิวงาน" มีวรรคคั่นกลางชื่อเมนู อ่านสะดุดและดูเหมือนพิมพ์ตก — ชื่อเมนู
                    ในแถบข้างคือ "ประเภทงาน" คำเดียว จึงเขียนติดกันเป็น "เมนูประเภทงาน"
                        (2026-08-12: เดิมชี้ "เมนูคิวงาน (ท้ายหน้า)" ซึ่งผิดสองชั้นหลังย้ายหน้า —
                        ชื่อเมนูเปลี่ยน และค่านั้นไม่ได้อยู่ท้ายหน้าปฏิทินอีกแล้ว)
                ...
                <span>
                  ร้านนี้รับนัดเป็นรายวัน จึงไม่ต้องกรอกเวลา — เปลี่ยนได้ที่เมนูประเภทงาน
                </span>
              </div>
            )}
