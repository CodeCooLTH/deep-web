...
export default function AppointmentDateSheet({
  ...
  return (
    ...
    >
      ...
      {/* 🛑 ห้าม gate ด้วย `!atTimeStep` — ขั้นเลือกเวลาคือขั้นที่ตัวเลขถูกใช้ตัดสินใจจริง
          (หัวแผ่นเขียน "รับพร้อมกันรวม N คิว" · กล่องช่วงเวลาเขียน "จองแล้ว n จาก N คิว" ·
          ชิปเวลาที่ย้อมว่า "เต็ม" ก็คิดจาก N ตัวเดียวกัน) การเอาป้ายออกตรงนั้นเพื่อประหยัด
          พื้นที่ คือการเลือกพื้นที่เหนือความถูกต้อง — ย่อข้อความแทน

          🛑 ข้อความต้องตรงกับสิ่งที่ระบบทำจริง: ฟอร์มไม่ได้ยิงเช็ก availability เองอีกแล้ว
          (AppointmentBlock ถอดออกตั้งแต่ 2026-08-08) ด่านจริงตัวเดียวคือตอนบันทึก ซึ่ง
          setOrRescheduleAppointment วน seat ครอบ SAVEPOINT — เขียนว่า "จะเช็กอีกครั้งตอน
          เลือกคิวในฟอร์ม" คือการอ้างพฤติกรรมที่ไม่มีอยู่ (ทิศกลับของ HR16) */}
      {aggregate && (
        <p className="text-default-500 mb-0 shrink-0 px-4 pb-2 text-xs">
          {atTimeStep
            ? 'ตัวเลขนี้รวมทุกคิวงาน — คิวที่เลือกจริงอาจเต็มกว่านี้'
            : 'ตัวเลขนี้รวมทุกคิวงาน ไม่ใช่ของคิวใดคิวหนึ่ง — ระบบจะตรวจความว่างของคิวที่เลือกอีกครั้งตอนบันทึก'}
        </p>
      )}
        ...
        {dayItems.length === 0 ? (
          ...
          >
            ...
            <p className="text-default-500 text-xs">
              ...
              {aggregate
                ? byDay
                  ? 'ยังไม่มีใครจองวันนี้ — จองได้เลย'
                  : 'ยังไม่มีใครจองวันนี้ — เลือกเวลาได้ตามสะดวก'
                : byDay
                  ? 'ยังไม่มีใครจองคิวนี้ — จองได้เลย'
                  : 'ยังไม่มีใครจองคิวนี้ — เลือกเวลาได้ตามสะดวก'}
            </p>
          </div>
        ) : (
          <div
