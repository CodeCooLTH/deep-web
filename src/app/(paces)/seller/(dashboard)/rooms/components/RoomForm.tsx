    ...
    try {
      ...
      if (!res.ok) {
        ...
        const map: Record<string, string> = {
          ...
          // feature 00028 — เดิมข้อความเดาว่าร้านที่ไม่ใช่บ้านพัก = "สินค้าและบริการ" เสมอ
          // ตอนนี้มี 2 ประเภทที่ไม่ใช่บ้านพัก (ขายออนไลน์/สินค้าและบริการ) จึงห้ามระบุชื่อประเภท
