          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-base">
            ...
            <div className="md:col-span-2 lg:col-span-3">
              ...
              <div className="lg:p-7.5 lg:border lg:border-default-300 lg:border-dashed">
                ...
                {/*
                  ปุ่มบันทึก — มือถือเท่านั้น (เดสก์ท็อปใช้ footer ด้านบนที่มีปุ่ม ย้อนกลับ/ถัดไป ด้วย)

                  🛑 **อยู่ "ในการ์ด" เดียวกับฟอร์ม ไม่ใช่ลอยล่างจอ และไม่ใช่ใต้การ์ด**
                  ผ่านมา 3 ตำแหน่งกว่าจะมาถึงตรงนี้ เก็บเหตุผลไว้ครบเพื่อไม่ให้ใครวนกลับ:

                    1. `sticky` ในการ์ด (2026-08-01) — ลอยทับช่องกรอกที่เหลือกลางฟอร์ม
                       เพราะ sticky ยังนับเป็นลูกของการ์ด จึงเลื่อนทับพี่น้องตัวเอง
                    2. `fixed` เหนือเมนูล่าง — user: "มันลอยแบบนี้กลัวเข้าใจผิด ปุ่มเหมือน
                       ออกจากระบบเลย แต่คนละสี" ปุ่มที่ค้างตำแหน่งเดียวกับปุ่มออกจากระบบตลอดเวลา
                       อ่านเป็นของชิ้นเดียวกัน โดยมีสีเป็นตัวแยกอย่างเดียว (Impeccable:
                       สีไม่ควรแบกความหมายเดี่ยว)
                    3. ใต้การ์ด (inline) — ยังลอยเดี่ยวอยู่นอกกรอบ อ่านไม่ออกว่าเป็นของฟอร์มไหน
                    4. **ในการ์ด ท้ายเนื้อหา** ← ตรงนี้ ผูกกับฟอร์มด้วยสายตาชัดเจน

                  ห่างจากช่องสุดท้ายด้วย `mt-6` + เส้นคั่นบน เพื่อไม่ให้อ่านเป็นฟิลด์อีกช่อง
                */}
