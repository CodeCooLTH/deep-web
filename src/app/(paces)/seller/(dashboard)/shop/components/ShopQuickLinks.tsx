 ...
 *
 * 🛑 label + icon + url ทั้งหมดคัดมาจาก `_seller-menu.ts` ซึ่งเป็น SSOT ของเมนู seller
...
const LINKS: QuickLink[] = [
  ...
  { url: '/settings', label: 'บัญชีที่เชื่อมต่อ', icon: 'link', hint: 'Facebook · LINE · Instagram' },
]
