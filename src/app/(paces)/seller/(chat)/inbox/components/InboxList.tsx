                  ...
                  <div className="flex min-w-0 flex-1 items-center gap-3">
                    ...
                    <span className="min-w-0 overflow-hidden text-start">
                      ...
                      {/* บรรทัด "ที่มา" (มติแบบ C 2026-08-09) — ตอบว่า "บัญชีไหน" ที่ badge มุม
                          ...
                          🛑 ขึ้นเฉพาะแพลตฟอร์มที่ร้านมี **ตั้งแต่ 2 บัญชีขึ้นไป** (`duplicatedProviders`)
                          — มีบัญชีเดียวบนแพลตฟอร์มนั้นจะไม่แสดงชื่อเลย เพราะ badge บอกครบแล้ว
                          บรรทัดนี้จึงไม่เพิ่มข้อมูล มีแต่กินที่ (พฤติกรรมที่ตั้งใจ ไม่ใช่บั๊ก —
                          ถูกถามซ้ำ 2026-08-16 ตอนเธรด LINE ไม่มีชื่อขณะที่ FB/IG มี)

                          🛑 **เธรด DEEP ไม่มีวันเข้าเงื่อนไขนี้** — `duplicatedProviders` สร้างจากแถว
                          `ShopChannel` ซึ่ง provider มีได้แค่ MESSENGER/INSTAGRAM/LINE ส่วน DEEP คือ
                          แชทในแอปเองที่ไม่มีแถว ShopChannel ⇒ ถูกตัดที่บรรทัดเงื่อนไขเสมอ
                          (คอมเมนต์เดิมตรงนี้เขียนว่าเธรด DEEP จะ "ใช้ชื่อว่าแอป Deep" ซึ่ง**ไม่จริง**
                          โค้ดนั้นไม่มีทางถูกเรียก — ลบข้อความนั้นทิ้งแล้ว 2026-08-16)

                          fallback `getChannelDisplay().label` ที่เหลืออยู่ ใช้กับเคสเดียว: เพจถูกถอด
                          ไปแล้วแต่เธรดเก่ายังอยู่ (`shopChannelId` ชี้แถวที่หายไป) → ถอยไปชื่อแพลตฟอร์ม */}
